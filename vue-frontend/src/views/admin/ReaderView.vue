        ...
        <el-main>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <!--用户信息表格-->
              <el-table ref="table" :data="readerTable" style="width: 100%" height="370">
                <el-table-column sortable prop="username" label="用户名" width="130"/>
                <el-table-column sortable prop="password" label="密码" width="120"/>
                <el-table-column sortable prop="nickname" label="昵称" width="120"/>
